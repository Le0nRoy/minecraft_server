...
function Write-UninstallScripts {
    ...
    $uninstallPs1Path = Join-Path $TargetInstancesDir "uninstall-infra-modpack.ps1"
    Invoke-WebRequest -Uri $UninstallPs1Url -OutFile $uninstallPs1Path -UseBasicParsing
